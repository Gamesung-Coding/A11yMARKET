...
function RouteComponent() {
  ...
  const tabs = [
    {
      label: '기본배송지',
      component: editingAddress?.id === defaultAddr?.id ? (
        <NewAddressForm
        ...
        <DefaultAddress defaultAddress={defaultAddr} onEdit={handleEdit} />
      ),
    },
    {
      label: '신규배송지',
      component: <NewAddressForm onSave={handleSave} onCancel={handleCancelEdit} />,
    },
    {
      label: '배송지목록',
  ...
  return (
    <div className="flex justify-center mt-20">
      <div className="w-full max-w-2xl py-8">
        ...
        <div className="flex mb-0">
          {tabs.map((tab, idx) => (
            <div
              ...
              className={`px-4 py-2 cursor-pointer rounded-t-md border border-b-0 border-gray-300 ${
        ...
        <div className="border border-gray-300 rounded-b-md bg-white p-4 -mt-[1px]">
