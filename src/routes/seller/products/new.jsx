  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* 1. 상품 기본정보 */}
          <div className="px-6 py-6" aria-label="상품 기본정보 섹션">
            <h2
          ...
          {/* 2. 판매정보 */}
          <div className="px-6 py-6" aria-label="판매정보 섹션">
            <h2
              className="font-kakao-big mb-4 text-sm font-semibold"
              aria-label="판매정보 제목"
            >
          ...
          {/* 3. 옵션 */}
          <div className="px-6 py-6" aria-label="옵션 섹션">
            <h2
              className="font-kakao-big mb-4 text-sm font-semibold"
              aria-label="옵션 정보 제목"
            >
          ...
          {/* 4. 재고 & 배송 */}
          <div className="px-6 py-6" aria-label="재고 및 배송 섹션">
            <h2
              className="font-kakao-big mb-4 text-sm font-semibold"
