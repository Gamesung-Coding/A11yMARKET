...
export default function AddressList({ addresses = [], onEdit, onDelete }) {
  return (
    <div className="border border-gray-300 rounded-md p-2">
      <div className="flex font-bold border-b border-gray-300 py-2">
      ...
      {addresses.map((addr) => (
        <div key={addr.id} className="flex items-center border-b border-gray-200 py-2">
          ...
          <div className="flex-[3]">({addr.zipcord}) {addr.address1} {addr.address2}</div>
