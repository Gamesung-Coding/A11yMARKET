...
export function RealtimeRanking({ data }) {
  ...
  return (
    <>
      <h2 className='mb-4 flex h-16 w-full items-center bg-neutral-300 px-8 text-2xl font-bold'>
        실시간 인기 상품
      </h2>
      <div className='relative flex w-[80%] flex-col items-center justify-center px-8 pb-8'>
              ...
              <div className='p-1'>
                <Card className='overflow-hidden pt-0 transition-transform hover:-translate-y-1 hover:opacity-90 hover:shadow-lg'>
                  ...
                  <CardFooter className='flex flex-col items-start gap-2 p-4'>
                    ...
                    <span className='text-md font-bold text-neutral-600'>{item.price}원</span>
                  </CardFooter>
                </Card>
              </div>
            ))}
        ...
        <Button
          variant='outline'
          size='icon'
          className={cn(apiButtonStyles, '-left-12')}
        ...
        <Button
          variant='outline'
          size='icon'
          className={cn(apiButtonStyles, '-right-12')}
